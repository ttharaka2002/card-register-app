  ...
  return (
    ...
    >
      ...
      <label className={styles.field}>
        Card Number
        <input className={styles.input} type="text" name="cardNumber" />
      </label>
      <div className={styles.inlineRow}>
        <label className={styles.field}>
          PIN
          <input className={styles.input} type="text" name="pin" />
        </label>
        <label className={styles.field}>
          Expiry
          <input className={styles.input} type="text" name="expiry" />
        </label>
      </div>
